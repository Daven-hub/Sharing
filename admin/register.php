    ...
    <div class="page-wrapper">
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="images/icon/logo.svg" alt="CoolAdmin">
                            </a>
                        </div>
        ...
        ?>   
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="nom" placeholder="Username">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="tel" name="tel" placeholder="Phone Number">
                                </div>
                                <div class="form-group">
                                    <label>Ville :</label>
                                    <input class="au-input au-input--full" type="text" name="city" placeholder="Ville">
                                </div>
                                <div class="form-group">
                                    <label>Photo de Profil</label>
                                    <input class="au-input au-input--full" type=file name=profil placeholder="Password">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="password" name="password_retype" placeholder="Confirm Password">
                                </div>
                                <div class="login-checkbox">
                                    <label>
                                        <input type="checkbox" name="aggree">Acccepter les termes de contrat et de Licences
                                    </label>
                                </div>
